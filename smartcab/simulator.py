...
class Simulator(object):
    ...
    def __init__(self, env, size=None, update_delay=2.0, display=True, log_metrics=False, optimized=False):
        ...
        if self.log_metrics:
            ...
            if a.learning:
                ...
                path = '/Users/apikzorian/Downloads/machine-learning-master/projects/smartcab/' + self.table_filename
                self.table_file = open(path, 'wb')
            else:
            ...
            path = '/Users/apikzorian/Downloads/machine-learning-master/projects/smartcab/' + self.log_filename
    ...
    def run(self, tolerance=0.05, n_test=10):
        ...
        while True:
            print("AZ Completed trial # " + str(total_trials))
            # Flip testing switch
            if not testing:
